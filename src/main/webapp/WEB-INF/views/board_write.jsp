		...
		<div class="section">
			<div class="form-group">
				...
				<div class="row">
					...
					<div class="col-sm-6">
						<label for="value1">주소 :</label> <input type="text" id="value1"
							class="form-control"> <label for="value2">근로조건 :</label>
						...
						<div class="form-group">
							...
							<label for="value2">참여 가능 인원 :</label> <input type="number"
								class="form-control" id="value2">
						</div>
