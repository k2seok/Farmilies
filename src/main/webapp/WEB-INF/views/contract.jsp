...
<body class="w3-light-grey">
	...
	<div class="w3-main" style="margin-left: 300px; margin-top: 43px;">
		...
		<div class="row">
			<div>
				<img name="picture_id" class="col-md-5"
					src="bootstrap3/img/default.jpg">
			</div>
			<div class="col-md-7">
				<form action="" method="post">
					<div class="row">
						...
						<div class="col-md-10">
							<input class="col-md-5 form-control input-sm" type="text"
								name="first_name">
						</div>
					</div>
					<div class="row">
					...
					<div class="row" style="text-align: center">
						<input type="button"
							style="margin: 10; background-color: blue; color: white"
							value="승인" class="btn btn-default" col="50" height="10">
						<input type="button" value="거절"
							style="margin: 10; background-color: red; color: white"
